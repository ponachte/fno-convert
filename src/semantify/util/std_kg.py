...
class StandardKG:
    ...
    def __init__(self):
        ...
        self.g += Graph().parse(files("semantify.functions").joinpath("control_flow.ttl"), format='turtle')
        self.g += Graph().parse(files("semantify.functions").joinpath("dockeronto.ttl"), format='turtle')
