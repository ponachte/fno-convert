...
class FunctionPicker(QWidget):
    ...
    function_loaded = pyqtSignal(PipelineGraph, URIRef) # signal that a new function is loaded
...
class ScrollWidget(QWidget):
    ...
    def setGraph(self, g: PipelineGraph):
        self.text.setPlainText(g.serialize(format='turtle'))
    
    def setSource(self, g: PipelineGraph, fun_uri: URIRef):
